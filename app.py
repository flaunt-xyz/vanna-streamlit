...
# Add a radio button for switching between tabs in the sidebar
tab = st.sidebar.radio("Navigation", ["Chat Interface", "Training Data"])

if tab == "Chat Interface":
    st.title("Vanna AI")
    ...
    # Add your training data interface here
    st.write("This is the training data interface")
    
    training_data = list_training_data()
    st.table(training_data)
    # Example components for the training data interface
    uploaded_file = st.file_uploader("Upload training data")
    if uploaded_file is not None:
        st.write("File uploaded successfully!")
    
    st.text_area("Or paste your training data here")
